...
const incrementCount = (productId, productCount) => (dispatch) =>
  dispatch({
    type: "APP/INCREMENT_COUNT",
    payload: { id: productId, count: productCount },
  });
const decrementCount = (productId, productCount) => (dispatch) =>
  dispatch({
    type: "APP/DECREMENT_COUNT",
    payload: { id: productId, count: productCount },
  });
